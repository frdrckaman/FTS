...
<div class="block block-drop-shadow">
    ...
    <div class="content list-group list-group-icons">
        <a href="info.php?id=1" class="list-group-item"><span class="icon-text-height"></span>Today Schedule Visits<i class="icon-angle-right pull-right"></i><?php if($tdy>0){?><span class="label label-success pull-right"><?=$tdy?></span><?php }?></a>
        ...
        <a href="info.php?id=5" class="list-group-item"><span class="icon-user"></span>Patients<i class="icon-angle-right pull-right"></i></a>
